...
FFMPEG_CFG_FLAGS="$FFMPEG_CFG_FLAGS --disable-appkit"
...
if [ "$FF_ARCH" = "i386" ]; then
    ...
    FF_XCRUN_OSVERSION="-mios-simulator-version-min=11.0"
    FFMPEG_CFG_FLAGS="$FFMPEG_CFG_FLAGS $FFMPEG_CFG_FLAGS_SIMULATOR"
elif [ "$FF_ARCH" = "x86_64" ]; then
    FF_BUILD_NAME="ffmpeg-x86_64"
    FF_BUILD_NAME_OPENSSL=openssl-x86_64
    FF_XCRUN_PLATFORM="macosx"
    FF_XCRUN_OSVERSION="-target x86_64-apple-ios13.0-macabi -isystem /Applications/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk/System/iOSSupport/usr/include -L/Applications/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk/System/iOSSupport/usr/lib"
    FFMPEG_CFG_FLAGS="$FFMPEG_CFG_FLAGS $FFMPEG_CFG_FLAGS_SIMULATOR"
elif [ "$FF_ARCH" = "armv7" ]; then
    FF_BUILD_NAME="ffmpeg-armv7"
    FF_BUILD_NAME_OPENSSL=openssl-armv7
    FF_XCRUN_OSVERSION="-mtvos-version-min=11.0"
...
echo "[*] check libssh"
echo "----------------------"
FFMPEG_DEP_LIBSSH_INC=/Users/zfu/proj/github/tvos.mpv.player/contrib/macCatalyst-ffmpeg/prebuilt/ios-${FF_ARCH}-macosx-darwin/libssh/include
FFMPEG_DEP_LIBSSH_LIB=/Users/zfu/proj/github/tvos.mpv.player/contrib/macCatalyst-ffmpeg/prebuilt/ios-${FF_ARCH}-macosx-darwin/libssh/lib
#--------------------
# with libssh
...
if [ -f "./config.h" ]; then
    ...
    export PKG_CONFIG_PATH="/Users/zfu/proj/github/tvos.mpv.player/contrib/macCatalyst-ffmpeg/prebuilt/ios-${FF_ARCH}-macosx-darwin/pkgconfig"
