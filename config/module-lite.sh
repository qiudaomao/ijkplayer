...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-ffserver"
...
#
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-devices"
...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-vfp"
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-neon"
